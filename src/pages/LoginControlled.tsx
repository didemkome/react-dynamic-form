...
export const LoginControlled = () => {
  ...
  const onSubmit = (data: LoginForm) => {
    alert("Controlled form submitted: " + JSON.stringify(data));
    navigate("/");
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4">
      <div className="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 className="text-2xl font-semibold mb-6 text-center">Login (Controlled)</h2>
        <Form<LoginForm> onSubmit={onSubmit}>
          {/* Pass controlled={true} for controlled input */}
          <FormField
            name="email"
            label="Email"
            type="email"
